...
__Мелодия__  
<audio className={"music"} controls={true} preload={"none"}><source src="mp3/462.mp3" type="audio/mpeg"/>
Your browser does not support the audio tag.
</audio>  

__Едноглас__  
<audio className={"music"} controls={true} preload={"none"}><source src="transp/462.mp3" type="audio/mpeg"/>
Your browser does not support the audio tag.
</audio>  
